var ComponentsDropdowns = function () {
    ...
    var handleSelect2Modal = function () {
        ...
        $("#select2_sample_modal_5").select2({
            tags: ["naturally ventilated", "air conditioned", "meals", "choice of meals", "TV", "telephone", "toiletries", "individual ceiling fan", "attached bathroom", "fully automatic bed", "semi-automatic bed"]
        });
